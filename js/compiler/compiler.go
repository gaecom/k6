...
func (c *Compiler) compileImpl(
	...
	if !main {
		...
		// removing the first newline make the sourcemaps for the rest work pretty great and I given the lack of any
		// golang sourcemap generation libraries the required work to fix this will be ... quite a lot.
		// Additionally hopefully one day we will support ESM and will drop this hack ... somehow
